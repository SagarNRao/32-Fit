...
data class User(
    ...
    fun addWorkout(
        ...
        val (armStrengthInc, chestStrengthInc, legStrengthInc) = workout.getTotalStrengthIncreases()
...
data class Exercise(
    ...
    val sizeIncrease: Int
        get() = ((sets * reps * weights * (difficulty / 10.0)).toInt() / 100).coerceAtLeast(1)
...
fun main() {
    val user = User(age = 25, gender = 'M', freqPerWeek = 3, experience = "Intermediate")
    ...
    println("Size Increases - Arms: $armSizeInc mm, Chest: $chestSizeInc mm, Legs: $legSizeInc mm")
    println(
