    ...
    try {
      ...
      if (mode === "bulk") {
        ...
        const cutPrediction: cutPrediction = {
          ...
          muscle_groups12: jsonResponse.result["12"]["muscle_groups"] || null,
        };
